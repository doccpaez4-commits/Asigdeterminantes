...
<h1>Metodología didáctica</h1>
<p class="lede">Aprendizaje Basado en Casos, aplicado a un mismo territorio durante todo el semestre</p>
...
<p class="muted" style="font-size:13px; margin-top:-8px;">Toca cada tarjeta para ver más detalle.</p>

<div class="concept-diagram">
  <div class="cd-node" data-expandable>
    <span class="expand-toggle">+</span>
    <span class="cd-icon">🔎</span>
    <div class="cd-title">1. Describir — Entrega 1</div>
    <div class="cd-desc">Diagnóstico del territorio desde los DSS: determinantes estructurales e intermedios, con fuentes secundarias y observación de campo.</div>
    <span class="expand-hint">Toca para ver más</span>
    <div class="cd-detail">El grupo organiza el territorio en capas de determinantes (Dahlgren-Whitehead o CSDH-OMS), combinando datos secundarios (DANE, ASIS) con observación de campo propia.</div>
  </div>
